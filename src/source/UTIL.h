...
#define SMOOTH_STEP_F32(x) mulf32( mulf32(x,x), (3 << 12) - mulf32(2 << 12, x) )
...
//	
//--------------------------------------
static inline s32 LerpSmoothf32( s32 start, s32 end, s32 t )
{
	
	s32 d = ( end - start );
	return ( start + mulf32( d, SMOOTH_STEP_F32(t) ) );
